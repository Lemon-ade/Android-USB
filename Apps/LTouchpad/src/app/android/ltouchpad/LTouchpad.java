...
public class LTouchpad extends Activity {
    ...
    public static Handler handler = new Handler() {
		public void handleMessage(Message msg) {
			...
			case HANDLE_WHAT_CONNECT_USBIP :
				...
				textConnect.setText("USBIP " + result);
				break;
			case HANDLE_WHAT_GET_MYIP :
				if(result.equals(HANDLE_MSG_CONNECTING)) {
					...
					pbarConnect.setVisibility(ProgressBar.INVISIBLE);
					btnState.setVisibility(Button.GONE);
					textConnect.setText("waiting PC (server IP : " + result + " )");
					connectClient();
				}
				break;
	...
	public static void connectUsbip() {
    	...
    	msg.what = HANDLE_WHAT_CONNECT_USBIP;
